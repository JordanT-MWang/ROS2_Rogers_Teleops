...
class MyNode(Node):
    ...
    def __init__(self):
        ...
        self.create_timer(0.00030, self.timer_callback)
        self.comport = serial.Serial(port='/dev/ttyUSB0', baudrate=500000,
                                     timeout=0.03, xonxoff=False, rtscts=False, write_timeout=None, 
    ...
    def write(self, msg: Point):
        ...
        #while self.comport.out_waiting < 8:
         #   pass
        #self.get_logger().info('data not full enoug to %s' % (data,))
